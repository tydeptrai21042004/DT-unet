#!/usr/bin/env python3
"""Run the architecture-only HF-U-Net ablation suite."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run architecture-only HF-U-Net ablation training/evaluation.")
    ...
    parser.add_argument("--output-root", type=str, default="outputs_arch_only_hf_ablation")
